...
function PolicyHeader({changeModalFlag, windowWidth}:Props){
        ...
        <ExternalWrapper>
            <LogoWrapper>
                <Link to={"/"}>
                    {
                        windowWidth > 370 ?
                            <LogoImage src={"./images/whiteFermaLogo.svg"}/>
                            :
                            <LogoImage src={"./images/shortWhiteFermaLogo.svg"}/>
                    }
                </Link>
            </LogoWrapper>
            <ContactWrapper>
                ...
                <ContactButtonWrapper onClick={()=>changeModalFlag(true)}>
                    <Button color={"#772A1A"} backgroundColor={"#FCFCFC"} text={"Позвоним бесплатно"}/>
